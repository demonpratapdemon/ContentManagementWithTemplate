...
<body>
<form id="myform">
<label for="0">Test1</label><input id="row0" disabled="true" value="1">1</input><input id="col0" disabled="true" value="2">2</input>
<br>
<textarea id="0" name="Test1" rows="10" cols="80"></textarea><label for="1">Test2</label><input id="row1" disabled="true" value="2">2</input><input id="col1" disabled="true" value="2">2</input>
<br>
<textarea id="1" name="Test2" rows="10" cols="80"></textarea><script type="text/javascript">
						var colATotal=
						2;
